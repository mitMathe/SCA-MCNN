...
G_OPEN_DATASET = "ascad50"
# "original" "moving_average" "pca"
G_PREPROCESS = "original"

G_DATA_ROOT_PATH   = "/content/drive/MyDrive/Colab_Data/04_MCNN/ASCAD/N0=50"
G_TRAIN_DATA_FILE  = G_DATA_ROOT_PATH + "/" + "ASCAD(N0=50)_profiling_50000tr_700pt.npy"
G_TRAIN_PLAIN_FILE = G_DATA_ROOT_PATH + "/" + "ASCAD(N0=50)_profiling_50000tr_700pt_plain.npy"
G_VALID_DATA_FILE  = G_DATA_ROOT_PATH + "/" + "ASCAD(N0=50)_validation_10000tr_700pt.npy"
G_VALID_PLAIN_FILE = G_DATA_ROOT_PATH + "/" + "ASCAD(N0=50)_validation_10000tr_700pt_plain.npy"

G_TRAIN_DATA_2_FILE = G_DATA_ROOT_PATH + "/" + "ASCAD(N0=50)_profiling_50000tr_700pt_poc.npy"
G_VALID_DATA_2_FILE = G_DATA_ROOT_PATH + "/" + "ASCAD(N0=50)_validation_10000tr_700pt_poc.npy"
...
def MCNN_SCA(LOG_FILE, FP_RESULT, FINAL_PATH, HYPERPARAMETER, GUESS_POS, GUESS_KEY, TRAIN_DATA, TRAIN_PLAIN, VALID_DATA, VALID_PLAIN, GPU_CONFIG):
    ...
    #(pc_train, pc_len) = PCA_REDUCTION(TRAIN_DATA)
    #(pc_valid, pc_len) = PCA_REDUCTION(VALID_DATA)
    pc_train = np.load(G_TRAIN_DATA_2_FILE)
    pc_valid = np.load(G_VALID_DATA_2_FILE)
    
    pc_train = pc_train[:G_TRAIN_NO,G_PT_ST:(G_PT_ED+1)]
    pc_valid = pc_valid[:(G_VALID_NO + G_ATTACK_NO),G_PT_ST:(G_PT_ED+1)]
