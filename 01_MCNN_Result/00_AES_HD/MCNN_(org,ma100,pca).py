...
def MCNN_ARCHI(HYPERPARAMETER_PRE_1, HYPERPARAMETER_PRE_2, HYPERPARAMETER_PRE_3):
    ...
    x1 = ig_1
    x1 = AveragePooling1D(2, strides=2, name='first_blockm1_pool')(x1)
    ...
    x2 = ig_2
    x2 = AveragePooling1D(2, strides=2, name='second_blockm1_pool')(x2)
    ...
    x3 = ig_3
    x3 = AveragePooling1D(2, strides=2, name='third_blockm1_pool')(x3)
